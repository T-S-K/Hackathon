...
class Detector:
    ...
    def downloadModel(self, modelURL):
        ...
        self.catcheDir = "./pretrained_models"

        os.makedirs(self.catcheDir, exist_ok=True)

        get_file(fname=fileName,
        origin=modelURL,cache_dir=self.catcheDir, cache_subdir="checkpoints", extract=True)

    def loadModel(self):
        print("Loading Model " + self.modelName)
        tf.keras.backend.clear_session()
        self.model = tf.saved_model.load(os.path.join(self.catcheDir, "checkpoints", self.modelName, "saved_model"))
